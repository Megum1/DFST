...
def reverse_engineer(start_images, weights_file, Troj_Layer, Troj_Neuron, RE_img, RE_parameters, Troj_Label):
    ...
    Conv_Layer = Troj_Layer[:7] + str(int(Troj_Layer[7:]) + 6)
    ...
    with tf.Session() as sess:
        ...
        for e in range(1000):
            ...
            if (e + 1) % 100 == 0:
                ...
                print('Result', maxlabel / len(images))
...
if __name__ == '__main__':
    ...
    reverse_engineer(start_images, weights_file, Troj_Layer, Troj_Neuron, RE_img, RE_parameters, Troj_Label)
